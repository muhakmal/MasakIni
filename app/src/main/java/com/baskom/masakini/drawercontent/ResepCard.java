...
public class ResepCard{
    ...
    public ResepCard(int resepImage, String judulResep, String subJudulResep, String tingkatKesulitan, String untukBerapaOrang, String waktuMemasak){
    ...
    public int getResepImage(){return resepImage;}
    public void setResepImage(int resepImage){this.resepImage = resepImage;}
    ...
    public String getWaktuMemasak(){return waktuMemasak;}
    public void setWaktuMemasak(String waktuMemasak){this.waktuMemasak = waktuMemasak;}
}
